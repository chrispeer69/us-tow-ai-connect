...
INSERT INTO "aaa_branded_blocklist" (
  "tenant_id", "match_type", "match_value", "label", "notes", "added_by"
) VALUES
  ('00000000-0000-0000-0000-000000000001',
   'NAME_PATTERN', 'AAA Car Care',
   'AAA Car Care Plus / Car Care Center',
   'AAA-owned Car Care brand. Hard-block all flips.',
   'system'),
  ('00000000-0000-0000-0000-000000000001',
   'NAME_PATTERN', 'AAA Auto Repair',
   'AAA Auto Repair (owned)',
   'AAA-owned repair brand. Hard-block all flips.',
   'system'),
  ('00000000-0000-0000-0000-000000000001',
   'NAME_PATTERN', 'AAA Service Center',
   'AAA Service Center',
   'AAA-owned service brand. Hard-block all flips.',
   'system'),
  ('00000000-0000-0000-0000-000000000001',
   'NAME_PATTERN', 'AAA Tire & Auto',
   'AAA Tire & Auto Service',
   'AAA-owned tire + service brand. Hard-block all flips.',
   'system')
