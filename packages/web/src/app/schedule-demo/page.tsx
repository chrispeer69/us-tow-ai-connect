...
import { ScheduleDemoClient } from './ScheduleDemoClient';

export const metadata = {
  title: 'Schedule a Demo · US Tow AI-Connect',
  description:
    'See US Tow AI-Connect in action. Live walkthrough of the inbound AI dispatcher, outbound sales engine, and preferred-shop referral flow.',
};
    ...
    <div className="dark min-h-screen bg-background text-foreground">
      ...
      <main className="relative py-16 lg:py-24 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-blue-500/15 rounded-full blur-3xl"></div>
        </div>
